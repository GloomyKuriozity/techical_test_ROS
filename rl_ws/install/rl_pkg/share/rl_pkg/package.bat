...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\rl_pkg\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\rl_pkg\hook\path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/rl_pkg/local_setup.bat"
